...
class _$AppStateTearOff {
  ...
  _AppState call(
      ...
      @JsonKey(ignore: true) AuthState authState = const AuthState.initial(),
...
abstract class $AppStateCopyWith<$Res> {
  ...
  $Res call(
      {User user,
      Community community,
      @JsonKey(ignore: true) AuthState authState,
      @JsonKey(ignore: true) bool isHandling});
...
class _$_AppState extends _AppState with DiagnosticableTreeMixin {
  const _$_AppState(
      ...
      @JsonKey(ignore: true) this.authState = const AuthState.initial(),
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AppState(user: $user, community: $community, authState: $authState, isHandling: $isHandling)';
  }
