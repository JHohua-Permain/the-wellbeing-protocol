...
class _$CommunityTearOff {
  ...
  _Community call(
      ...
      @JsonKey(ignore: true) List<CommunityMember> members = const [],
      @JsonKey(ignore: true) Map<String, CommunityShop> shops = const {}}) {
    return _Community(
...
mixin _$Community {
  ...
  @JsonKey(ignore: true)
  Map<String, CommunityShop> get shops => throw _privateConstructorUsedError;
...
abstract class $CommunityCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(ignore: true) List<CommunityMember> members,
      @JsonKey(ignore: true) Map<String, CommunityShop> shops});
    ...
    return _then(_value.copyWith(
      ...
      shops: shops == freezed
          ...
          : shops // ignore: cast_nullable_to_non_nullable
              as Map<String, CommunityShop>,
    ));
  }

  @override
  $TokenCopyWith<$Res>? get homeToken {
    if (_value.homeToken == null) {
      return null;
    }
...
class _$_Community with DiagnosticableTreeMixin implements _Community {
  const _$_Community(
      ...
      @JsonKey(ignore: true) this.members = const [],
      @JsonKey(ignore: true) this.shops = const {}});
...
abstract class _Community implements Community {
  const factory _Community(
      ...
      String communityFund,
      @JsonKey(ignore: true) List<CommunityMember> members,
      @JsonKey(ignore: true) Map<String, CommunityShop> shops}) = _$_Community;
